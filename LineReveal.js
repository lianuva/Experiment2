...
let vOutcomes    = js_vars.score_string.split('[')[1].split(','); //!changed vOutcomes
let correcttables_string = js_vars.correcttables_string.split(',');
...
console.log(correcttables_string);
